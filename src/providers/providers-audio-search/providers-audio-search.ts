...
import { ProvidersGetJsonProvider } from '../providers-get-json/providers-get-json';
...
@Injectable()
export class ProvidersAudioSearchProvider {

  audioSearchResults: Observable<any>;
	rgDB = null;

  constructor(public http: HttpClient, private getJson: ProvidersGetJsonProvider) {
    console.log('Hello ProvidersAudioSearchProvider Provider');
    this.getJson.getJson('/assets/json/rgDB.json').subscribe( data => { 
			this.rgDB = data; 
